  ...
  return (
    <section>
        <div className='p-3 flex flex-col items-center gap-8'>
            <Image src={collectionDetails.image} width={1500} height={500} alt='collection' className='w-full h-[200px] object-cover rounded-xl'/>
            <p className='text-heading3-bold uppercase'>{collectionDetails.title}</p>
            <p className='hidden text-body-normal text-grey-2 text-center max-w-[900px] lg:block'>{collectionDetails.description}</p>
                ...
                <div className="mx-auto max-w-screen px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                    ...
                    <div className="mt-4 lg:mt-8 lg:grid lg:grid-cols-4 lg:items-start lg:gap-8">
                        ...
                        <div className="lg:col-span-3">
                            <ul className="grid gap-4 grid-cols-2 sm:grid-cols-2 lg:grid-cols-4">
